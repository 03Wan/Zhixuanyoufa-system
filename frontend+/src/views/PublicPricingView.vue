<template>
  <main class="public-page pricing-page">
    ...
    <section class="public-dark-hero pricing-hero">
      <div class="public-shell pricing-hero-layout">
        <div>
          ...
          <h1 class="public-title"><span class="public-title-line">先用真实 Listing 验证价值，</span><span class="public-title-line">再为团队效率付费</span></h1>
    ...
    <section class="public-section pricing-addons-section">
      <div class="public-shell">
        <div class="public-section-head center">
...
import { PUBLIC_PLAN_ADD_ONS, PUBLIC_PLANS, PUBLIC_PRICING_NOTICE } from '@/data/publicPricing';

const router = useRouter();
const plans = PUBLIC_PLANS;
const addOns = PUBLIC_PLAN_ADD_ONS;
const notice = PUBLIC_PRICING_NOTICE;
...
@media(min-width:1101px){.rules-layout{grid-template-columns:560px minmax(0,1fr)}.rules-layout>.public-section-head{max-width:560px;margin-top:60px}}
@media(max-width:1100px){.pricing-hero-layout,.rules-layout{grid-template-columns:1fr}.pricing-hero-layout{padding:62px 0;gap:35px}.rules-layout>.public-section-head{max-width:100%;margin-top:0}}
</style>
