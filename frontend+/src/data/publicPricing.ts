...
export const PUBLIC_PRICING_NOTICE = '首批共创价面向前30家付费客户或公开上线后90天内购买的客户；价格锁定12个月。';
...
export const PUBLIC_PLAN_ADD_ONS: PublicPlanAddOn[] = [
