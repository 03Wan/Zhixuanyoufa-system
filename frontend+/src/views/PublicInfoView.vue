...
const pages = {
  '/product-capabilities': {
    kicker: '产品能力', title: '让每一份素材，都有发布依据', summary: '把标题、卖点、图片与详情页纳入同一套发布前审校框架，连接适用规则、风险解释、修改方案和最终决策。',
  ...
  '/solutions': {
    kicker: '解决方案', title: '把上架前判断，变成团队工作流', summary: '让运营、设计、品牌与复核角色围绕同一份素材、同一套规则和同一个发布结论协作。',
